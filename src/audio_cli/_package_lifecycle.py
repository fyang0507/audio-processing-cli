"""Private-API guard verification, removal, and purge operations."""
...
from ._package_core import HUB_CACHE_NOTE, UNTOUCHED, ProvisioningError
from ._package_paths import managed_environment_path
from ._package_registry import load_registry, save_registry
from ._package_requirements import _class_of, _method_of, _module_of
...
class LifecycleMixin:
    ...
    def purge(self, *, dry_run: bool) -> dict:
        ...
        known, unsized = _selection_bytes(
            [_packages()[i] for i in package_ids if i in _packages()], document)
