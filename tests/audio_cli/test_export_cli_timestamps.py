...
from tests.audio_cli.export.export_cli_test_support import _write_result
from tests.docs.shipped_command_test_support import documented_block, documented_fenced_block

EXPORT_CONTRACT = Path(__file__).resolve().parents[2] / "docs" / "TRANSCRIBE_CONTRACT.md"
