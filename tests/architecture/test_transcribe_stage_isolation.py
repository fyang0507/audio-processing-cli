...
from tests.architecture.transcribe_boundary_inventory import EXPECTED_STAGE_RUNTIME_IMPORTS
from tests.architecture.transcribe_boundary_test_support import (
    imported_roots,
    module_name,
    python_source_paths,
)

TRANSCRIBE = Path(__file__).resolve().parents[2] / "src" / "audio_cli" / "transcribe"
